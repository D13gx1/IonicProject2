...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButton, IonButtons, IonIcon, IonCardContent, IonCardHeader, IonCard, IonCardTitle } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonCardTitle, IonCard, IonCardHeader, IonCardContent, IonIcon, IonButtons, IonButton, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, HeaderComponent]
})
export class CodigoQrPage implements OnInit {
  ...
  // Función para iniciar el escaneo de código QR desde la cámara
